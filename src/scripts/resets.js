const localReset = () => {
  player.frogAmount = new Decimal('1e100');
  ...
  player.ponds.frog.tier7.cost = new Decimal('1e24');
  player.ponds.frog.tier8.cost = new Decimal('1e30');
  player.ponds.frog.tier9.cost = new Decimal('1e36');
  player.ponds.frog.tier10.cost = new Decimal('1e50');
  ...
  player.ponds.frog.tier7.mult = new Decimal('1');
  player.ponds.frog.tier8.mult = new Decimal('1');
  player.ponds.frog.tier9.mult = new Decimal('1');
  player.ponds.frog.tier10.mult = new Decimal('1');
  ...
  player.ponds.frog.tier7.amountBought = new Decimal('0');
  player.ponds.frog.tier8.amountBought = new Decimal('0');
